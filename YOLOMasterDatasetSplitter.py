...
class YOLOMasterDatasetSplitter:
  ...
  def run(self, yolo_master_dir, splitted_train_dir, splitted_valid_dir, classes_file):
    ...
    master_classes_file = os.path.join(yolo_master_dir, "classes.txt")
    shutil.copy2(classes_file, master_classes_file)
...
if __name__ == "__main__":
  ...
  try:
    ...
    splitter.run(yolo_master_dir, splitted_train_dir, splitted_valid_dir, classes_file)
