...
class YOLO2TFRecordConverter:
  ...
  def run(self):
    ...
    prefix = ""
    tfrecord_path = os.path.join(tfrecord_dir, prefix + self.filename)
    print("---------------------{}".format(tfrecord_path))
...
# Example:
# python YOLO2TFRecordConverter.py ./projects/Signals/autoannotaed_yolo2tfrecord_converter.conf
